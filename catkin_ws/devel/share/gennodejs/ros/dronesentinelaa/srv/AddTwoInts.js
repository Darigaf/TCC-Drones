...
// (in-package dronesentinelaa.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'dronesentinelaa/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dronesentinelaa/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'dronesentinelaa/AddTwoInts'; }
};
